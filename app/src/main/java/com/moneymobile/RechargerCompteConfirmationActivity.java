...
public class RechargerCompteConfirmationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		montant				= bundle.getInt("recharge");
		...
		valider.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (networkInfo != null && networkInfo.isAvailable() && networkInfo.isConnected()) {
					...
					Toast.makeText(RechargerCompteConfirmationActivity.this, "Vous n'etes pas connecté à Internet", Toast.LENGTH_LONG).show();
					ActivityUtil.switchActivity(RechargerCompteConfirmationActivity.this, GererMonCompteActivity.class, new Bundle(), true);
				}
	...
	private class validerTask extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			pd = new ProgressDialog(RechargerCompteConfirmationActivity.this);
		...
		protected void onPostExecute(String result) {
			...
			Toast.makeText(RechargerCompteConfirmationActivity.this, result, Toast.LENGTH_LONG).show();
			ActivityUtil.switchActivity(RechargerCompteConfirmationActivity.this, GererMonCompteActivity.class, bundle, true);
		}
	}
